// VIO 83 AI ORCHESTRA — System Prompt Certificato Ultra-Specializzato
// Questo file contiene il system prompt master e i prompt specializzati
// per ogni campo del sapere umano. NESSUNA generalizzazione.

// ============================================================
// PROMPT MASTER — iniettato in OGNI chiamata
// ============================================================

export const VIO83_MASTER_PROMPT = `Sei VIO 83 AI Orchestra — sistema di intelligenza artificiale ultra-specializzato.
...
// Aggiunti dopo il master prompt in base alla classificazione
// ============================================================
