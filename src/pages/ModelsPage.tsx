...
const ALL_MODELS: AIModelInfo[] = [
  {
    ...
    mode: 'cloud',
    description:
      'Flagship Anthropic per agenti, coding avanzato, ricerca multi-step e reasoning ad altissima affidabilità.',
    maxTokens: 128000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Agents', 'Code', 'Research', 'Legal', 'Medical'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Bilanciamento top fra velocità, tool use, scrittura professionale e sviluppo software serio.',
    maxTokens: 64000,
    contextWindow: 1000000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Fast Code', 'Writing', 'Analysis', 'Agents'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Flagship OpenAI per reasoning complesso, coding professionale, strumenti, MCP e workflow agentici.',
    maxTokens: 128000,
    contextWindow: 1000000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Reasoning', 'Coding', 'Agents', 'Tools'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Variante OpenAI veloce e più economica per task ad alto volume senza scendere troppo di qualità.',
    maxTokens: 128000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Fast General', 'Automation', 'Bulk Tasks'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'xAI punta su reasoning + tool use + contesto enorme. Molto forte per realtime se abbini ricerca server-side.',
    maxTokens: 8192,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Realtime', 'Research', 'Tool Use', 'Long Context'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Google top model per ragionamento, coding, multimodalità e documenti lunghissimi.',
    maxTokens: 8192,
    contextWindow: 1000000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Long Context', 'Coding', 'Research', 'Multimodal'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Versione Google ad alto rapporto prezzo/prestazioni per workload rapidi, continui e multimodali.',
    maxTokens: 8192,
    contextWindow: 1000000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Fast Search', 'Long Context', 'High Volume'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Stack Mistral top-tier per multilingua, enterprise EU, document understanding e contenuti complessi.',
    maxTokens: 8192,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Multilingual', 'EU', 'Translation', 'Enterprise'],
    supportsVision: true,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Molto forte per matematica, logica, coding e reasoning strutturato con costo aggressivo.',
    maxTokens: 64000,
    contextWindow: 128000,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Math', 'Reasoning', 'Logic', 'Code'],
  ...
  },
  {
    ...
    mode: 'cloud',
    description:
      'Integrazione ultra-rapida per task agentici, reasoning e automazioni ad alta velocità.',
    maxTokens: 65536,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Speed', 'Automation', 'Agents', 'Code'],
    supportsVision: false,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Ricerca web grounded, citazioni e analisi orientata a fact-finding e investigative workflows.',
    maxTokens: 32768,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Web Research', 'Citations', 'Current Events'],
    supportsVision: false,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Ottimo canale elastico per fallback, testing multi-provider e accesso rapido a modelli community/partner.',
    maxTokens: 8192,
    contextWindow: 131072,
    costPer1kInput: 0,
    costPer1kOutput: 0,
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Fallback', 'Multi-provider', 'Experiments'],
    supportsVision: false,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'cloud',
    description:
      'Buona opzione economica per reasoning generalista e throughput cloud indipendente.',
    maxTokens: 8192,
    contextWindow: 131072,
    ...
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Budget Cloud', 'Generalist', 'Reasoning'],
    supportsVision: false,
    supportsTools: true,
    status: 'standby',
  },
  {
    ...
    mode: 'local',
    description:
      'Modelli locali su MacBook Air M1. Zero costi, zero dati trasmessi. Privacy totale.',
    maxTokens: 4096,
    contextWindow: 32000,
    costPer1kInput: 0,
    costPer1kOutput: 0,
    speedScore: 99,
    qualityScore: 99,
    specialties: ['Privacy', 'Offline', 'Code'],
    supportsVision: false,
    supportsTools: false,
    status: 'online',
  },
    ...
    <div style={{ padding: '28px 32px', overflowY: 'auto', height: '100%' }}>
      ...
      >
        ...
        <p style={{ color: 'var(--vio-text-dim)', fontSize: '12px', margin: '0 0 14px' }}>
          {t('modelsPage.eliteSource')}{' '}
          <code style={{ color: 'var(--vio-cyan)' }}>/orchestration/elite-stacks</code>
        </p>

        {eliteLoading && (
          <div style={{ color: 'var(--vio-cyan)', fontSize: '12px' }}>
            {t('modelsPage.loadingElite')}
          </div>
        )}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div
                    style={{ color: 'var(--vio-text-primary)', fontSize: '15px', fontWeight: 700 }}
                  >
                    {m.name}
                  </div>
                  <div style={{ color, fontSize: '11px', fontWeight: 600 }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ color: 'var(--vio-text-dim)', fontSize: '10px', width: '50px' }}>
                    {t('modelsPage.quality')}
                  </span>
              ...
              >
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                  ...
                  {m.supportsVision && (
                    <span title="Supporta visione">
                      <Eye size={12} color="var(--vio-cyan)" />
                    </span>
                  )}
                  {m.supportsTools && (
                    <span title="Supporta tool">
                      <Wrench size={12} color="var(--vio-magenta)" />
                    </span>
                  )}
                  {m.mode === 'local' ? (
                    <span title="Locale">
                      <WifiOff size={12} color="var(--vio-green)" />
                    </span>
                  ) : (
                    <span title="Cloud">
                      <Wifi size={12} color="var(--vio-cyan)" />
                    </span>
                  )}
                </div>
                <span
                  style={{
                    ...
                    fontSize: '11px',
                    fontWeight: m.costPer1kOutput === 0 ? 700 : 400,
                  }}
                >
