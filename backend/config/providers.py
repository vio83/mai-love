...
ELITE_TASK_STACKS = {
    ...
    "coding_agent_max": {
        ...
        "secondary": ["gpt-4o", "deepseek-reasoner", "llama-3.3-70b-versatile"],
        "local": ["qwen2.5-coder:3b", "codellama:latest"],
        "best_for": ["codebase surgery", "tool-using agents", "refactor complessi", "debug profondo"],
    },
    "legal_research_max": {
        "primary": ["claude-opus-4-20250514", "pro-search", "deep-research"],
        "secondary": ["gemini-2.5-pro-preview-06-05", "mistral-large-latest"],
    ...
    "writing_editorial_max": {
        "primary": ["claude-sonnet-4-20250514", "gpt-4o"],
    ...
    "realtime_deep_research_max": {
        "primary": ["deep-research", "pro-search", "grok-2-latest"],
        "secondary": ["gemini-2.5-pro-preview-06-05", "claude-opus-4-20250514"],
        "local": ["llama3.2:3b"],
