...
Ogni nodo include:
  - provider_optimal: migliore AI provider per questo dominio
...
class TaxonomyNode:
    ...
    provider_optimal: str               # claude/openai/gemini/mistral/deepseek/ollama
...
_add(TaxonomyNode(
    ...
    parent_id=None, level=0, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id=None, level=0, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id=None, level=0, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="TECH", level=1, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="SCI", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="SCI", level=1, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="MED", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    keywords_en=("drug","dosage","contraindication","interaction","active ingredient","dosing","side effects","antibiotic","analgesic"),
    complexity=5, requires_reasoning=True, requires_web=False, citation_needed=True,
))
...
_add(TaxonomyNode(
    ...
    parent_id="MED", level=1, provider_optimal="claude", provider_fallback="openai",
    temperature=0.2, max_tokens=3072, system_fragment="Sei un nutrizionista e dietologo. Basa consigli su evidenze scientifiche. Considera patologie e intolleranze.",
...
_add(TaxonomyNode(
    ...
    parent_id="LAW", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="FIN", level=1, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="FIN", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="BUS", level=1, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="ART", level=1, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="ART", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="ART", level=1, provider_optimal="gemini", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="EDU", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="EDU", level=1, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="EDU", level=1, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="PSY", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="CRE", level=1, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="CRE", level=1, provider_optimal="openai", provider_fallback="claude",
...
_add(TaxonomyNode(
    ...
    parent_id="CRE", level=1, provider_optimal="claude", provider_fallback="gemini",
    temperature=0.98, max_tokens=2048, system_fragment="Sei un poeta. Usa immagini vivide, metafore originali, ritmo studiato. Sperimenta con forma e contenuto.",
...
_add(TaxonomyNode(
    ...
    parent_id="CRE", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    parent_id="ENV", level=1, provider_optimal="claude", provider_fallback="gemini",
...
_add(TaxonomyNode(
    ...
    parent_id="SOC", level=1, provider_optimal="claude", provider_fallback="openai",
...
_add(TaxonomyNode(
    ...
    keywords_it=("sociologia","antropologia","cultura","identità","classe sociale","disuguaglianza","migrazione","urbanizzazione","globalizzazione"),
...
for spec_id, name_it, name_en, kw_it, kw_en in [
    ...
    _add(TaxonomyNode(
        ...
        provider_optimal="openai", provider_fallback="claude",
...
for spec_id, name_it, name_en, kw_it, kw_en, provider in [
    ...
    _add(TaxonomyNode(
        ...
        provider_optimal=provider, provider_fallback="claude",
...
for spec_id, name_it, name_en, kw_it, kw_en in [
    ...
    _add(TaxonomyNode(
        ...
        provider_optimal="claude", provider_fallback="openai",
...
def classify_text(text: str, max_results: int = 3) -> List[Tuple[str, TaxonomyNode, int]]:
    ...
    word_tokens = set(text_lower.split())
    scores: Dict[str, int] = {}
...
def get_optimal_config(text: str) -> Dict:
    ...
    return {
        ...
        "provider": node.provider_optimal,
        "provider_fallback": node.provider_fallback,
